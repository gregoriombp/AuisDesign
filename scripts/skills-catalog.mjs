...
const RECOMMENDED = new Set([...COWORK, "auis-review-bridge-solve", "auis-voice", "auis-ux-writing", "auis-setup", "auis-brand"])
...
const CLAUDE_ONLY = new Set(["auis-edit-bridge-solve"])
