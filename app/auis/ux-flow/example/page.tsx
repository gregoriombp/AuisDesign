...
const updates: FlowUpdate[] = [
  {
    date: "2026-09-10",
    summary:
      "Moved to the dedicated UX Flow hub; the diagram now uses the full editor with suggestions, comments and subflow expansion.",
    tags: ["integration"],
  },
  {
    date: "2026-07-16",
    ...
    <>
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-16 px-10 pb-14">
        <p className="max-w-2xl text-sm leading-relaxed text-fg-secondary">
          This is documentation, not a product journey. Click a screen to preview its
          real route in the side panel; use the editor controls to see the same comment
          and suggestion workflow available to new flows.
        </p>
        ...
        <Section
          id="screens"
          title="Every screen"
          lead="The example uses routes shipped by Auis, so every preview resolves in a fresh clone."
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            <AuCard className="p-5">
              ...
              <p className="mt-2 text-sm leading-relaxed text-fg-secondary">
                One decision demonstrates handle-specific branches and convergence without
                importing a private scenario.
              </p>
            </AuCard>
            <AuCard className="p-5">
              <h3 className="text-base font-medium text-fg-primary">Resolvable links</h3>
              <p className="mt-2 text-sm leading-relaxed text-fg-secondary">
                Every href points at a route shipped by Auis, so the preview drawer has no
                hidden product dependency.
              </p>
            </AuCard>
          </div>
        </Section>
