...
import { Section } from "../../styleguide/_primitives"
            ...
            <div className="flex items-baseline gap-3 flex-wrap">
              ...
              {u.tags.map((t) => {
                ...
                return (
                  <span
                    key={t}
                    className="inline-flex items-center rounded-sm border px-2 py-0.5 text-3xs font-medium uppercase tracking-wide"
