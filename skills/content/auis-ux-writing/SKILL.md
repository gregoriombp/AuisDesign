...
- **Route / internal link** (`/onboarding`, `127.0.0.1:3000/...`, `localhost:3000/...`, `?step=`) → **TARGET**. Map it to the file: `app/<route>/page.tsx` + local `_components/`. If the route has tabs/sub-routes, read the tabs file and list the children.
