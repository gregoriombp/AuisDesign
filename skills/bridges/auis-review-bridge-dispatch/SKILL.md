...
> `@germano`, you **spawn the `germano` subagent** (the Agent tool with
> `subagent_type: "germano"`, defined in `.claude/agents/germano.md`) with the
...
1. Spawn the `germano` subagent (the **Agent** tool, `subagent_type: "germano"`)
...
- **Germano runs as a real subagent** (`subagent_type: "germano"`), never as the
