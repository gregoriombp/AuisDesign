...
> system and tokens already exist; do not re-bootstrap from an image.
> To touch tokens/foundation, use **`auis-design-system-foundation`**
> (the only skill authorized to create tokens). See the "Routing" table in `AGENTS.md`.
